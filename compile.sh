...
pdflatex -jobname=pdf/ch13 "\includeonly{tex/mcds-bias-variance}\input{document}"
pdflatex -jobname=pdf/ch14 "\includeonly{tex/mcds-feature-selection}\input{document}"
