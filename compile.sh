...
pdflatex -jobname=pdf/ch10 "\includeonly{tex/mcds-generalized-linear-models}\input{document}"
pdflatex -jobname=pdf/ch11 "\includeonly{tex/mcds-kaplan-meier}\input{document}"
pdflatex -jobname=pdf/ch12 "\includeonly{tex/mcds-feature-selection}\input{document}"
