...
p <- ggplot() + geom_histogram(aes(x=x), alpha=0.5, binwidth=0.5) + xlab("x")  + 
  geom_histogram(aes(x=x.mean), alpha=0.5, fill="blue", binwidth=0.5) + xlab("") + theme_minimal()
ggsave(p, filename = "/Users/beth/Documents/mssm/statistics-club/img/hyp-norm-mean.png", height=3, width=4, units="in", dpi=300)
...
p <- ggplot() + geom_histogram(aes(x=x), alpha=0.5, binwidth=0.5) + xlab("x")  + 
  geom_histogram(aes(x=x.mean), alpha=0.5, fill="blue", binwidth=0.5) + xlab("") + theme_minimal()
ggsave(p, filename = "/Users/beth/Documents/mssm/statistics-club/img/hyp-pois-mean.png", height=3, width=4, units="in", dpi=300)
...
p <- ggplot() + geom_histogram(aes(x=x), alpha=0.5, binwidth=0.5) + xlab("x")  + 
  geom_histogram(aes(x=x.mean), alpha=0.5, fill="blue", binwidth=0.5) + xlab("") + theme_minimal()
ggsave(p, filename = "/Users/beth/Documents/mssm/statistics-club/img/hyp-exp-mean.png", height=3, width=4, units="in", dpi=300)
...
p <- ggplot() + geom_histogram(aes(x=x), alpha=0.5, binwidth=0.05) + xlab("x")  + 
  geom_histogram(aes(x=x.mean), alpha=0.5, fill="blue", binwidth=0.05) + xlab("") + theme_minimal()
ggsave(p, filename = "/Users/beth/Documents/mssm/statistics-club/img/hyp-sum-mean.png", height=3, width=4, units="in", dpi=300)
...
ggsave(p, filename = "/Users/beth/Documents/mssm/statistics-club/img/hyp-z-test-example-0.png", height=3, width=4, units="in", dpi=300)

p <- ggplot() + geom_histogram(aes(x=x), alpha=0.5, binwidth=2) + xlab("") + theme_minimal() + 
  geom_vline(xintercept = 125.45, color = "red", linetype = "dashed")
ggsave(p, filename = "/Users/beth/Documents/mssm/statistics-club/img/hyp-z-test-example-1.png", height=3, width=4, units="in", dpi=300)
...
ggsave(p, filename = "/Users/beth/Documents/mssm/statistics-club/img/hyp-z-test-example.png", height=3, width=4, units="in", dpi=300)

p <- ggplot() + geom_histogram(aes(x=x), alpha=0.5, binwidth=2) + 
  geom_histogram(aes(x=x.mean), alpha=0.5, fill="blue", binwidth=2) + xlab("") + theme_minimal() + 
    geom_vline(xintercept = 125.45, color = "red", linetype = "dashed")
ggsave(p, filename = "/Users/beth/Documents/mssm/statistics-club/img/hyp-z-test-example-2.png", height=3, width=4, units="in", dpi=300)
...
ggsave(p, filename = "/Users/beth/Documents/mssm/statistics-club/img/hyp-z-test-example-3.png", height=3, width=4, units="in", dpi=300)
...
p <- ggplot() + geom_density(aes(x=x, y = dens), stat = "identity", 
  ...
  geom_vline(xintercept = l2, color = "black", linetype = "dotted") + theme_minimal() + ylab("Density") + 
  xlab("Sample Mean (n = 20)")
ggsave(p, filename = "/Users/beth/Documents/mssm/statistics-club/img/hyp-z-test-example-4.png", height=3, width=4, units="in", dpi=300)
...
p <- ggplot() + geom_density(aes(x=x, y = dens), stat = "identity", 
  ...
  xlab("Sample Mean (n = 20)")
ggsave(p, filename = "/Users/beth/Documents/mssm/statistics-club/img/hyp-z-test-example-5.png", height=3, width=4, units="in", dpi=300)
```
...
```{r z-score calculations}
z = (148.29-139.75)/21.40
zbar = (148.29-139.75)/(21.40/sqrt(20))
1 - pnorm(z,0,1)
1 - pnorm(zbar,0,1)
```
...
```{r plots, echo=FALSE}
ggsave(p1, filename = "/Users/beth/Documents/mssm/statistics-club/img/hyp-z-test-power-curve-1.png", height=3, width=4, units="in", dpi=300)
ggsave(p2, filename = "/Users/beth/Documents/mssm/statistics-club/img/hyp-z-test-power-curve-2.png", height=3, width=4, units="in", dpi=300)
```
...
ggsave(p, filename = "/Users/beth/Documents/mssm/modern-clinical-data-science/figures/hyp-z-test-example-3-z.png",
...
p <- ggplot() + geom_density(aes(x=x, y = dens), stat = "identity", 
  ...
  geom_vline(xintercept = l2, color = "black", linetype = "dotted") + theme_minimal() + ylab("Density") + 
  xlab("Z-Statistic (n = 20)")
ggsave(p, filename = "/Users/beth/Documents/mssm/modern-clinical-data-science/figures/hyp-z-test-example-4-z.png",
       height=3, width=4, units="in", dpi=300)

p <- ggplot() + geom_density(aes(x=x, y = dens), stat = "identity", 
                             fill = "blue", colour = NA, alpha = 0.6) + 
  geom_vline(xintercept = (125.45 - 139.75)/(21.40/sqrt(20)), color = "red", linetype = "dashed") + 
  theme_minimal() + ylab("Density") + xlab("Z-Statistic (n = 20)")
ggsave(p, filename = "/Users/beth/Documents/mssm/modern-clinical-data-science/figures/hyp-z-test-example-5-z.png",
       height=3, width=4, units="in", dpi=300)
```
...
ggsave(p1, 
       filename="/Users/beth/Documents/mssm/statistics-club/img/power-original-distributions.png",
...
ggsave(p2, 
       filename="/Users/beth/Documents/mssm/statistics-club/img/power-sampling-distributions.png",
       height = 3, width = 5, units = "in", dpi=300)
...
p3 <- ggplot() + geom_histogram(aes(x=p.values.null), alpha = 0.5, fill = "gray50") + 
  ...
  ylab("Frequency")
ggsave(p3, 
       filename="/Users/beth/Documents/mssm/statistics-club/img/power-hist-pvalues.png",
       height = 3, width = 5, units = "in", dpi=300)
```
